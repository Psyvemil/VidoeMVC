    ...
    public partial class salam1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VideoCasts", x => new { x.VideoId, x.UserId });
                    table.ForeignKey(
                        name: "FK_VideoCasts_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VideoComments", x => new { x.VideoId, x.CommentId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_VideoComments_Comments_CommentId",
                        column: x => x.CommentId,
                        principalTable: "Comments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VideoLikes", x => new { x.VideoId, x.LikeDislikeId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_VideoLikes_LikeDislikes_LikeDislikeId",
                        column: x => x.LikeDislikeId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VideoComments_CommentId",
                table: "VideoComments",
                column: "CommentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VideoLikes_LikeDislikeId",
                table: "VideoLikes",
